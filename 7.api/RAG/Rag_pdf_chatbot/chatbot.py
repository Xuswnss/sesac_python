...
import os
from vectorsotre import get_store
path = os.path.abspath("RAG/Rag_pdf_chatbot")
PROMPT_JSON_FILE = "prompt.json"
PROMPT_YAML_FILE = "prompt.yaml"
PATH = os.path.join(path, PROMPT_YAML_FILE)
...
def initialize_llm():
    ...
    prompt = _load_prompts_from_yaml(PATH)["default_prompt"]
